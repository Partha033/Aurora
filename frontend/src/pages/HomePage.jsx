    ...
    <div className="pt-16">
      ...
      <section className="min-h-[calc(100vh-64px)] bg-[#020617] flex flex-col md:flex-row items-center justify-center md:justify-between px-6 sm:px-12 md:px-20 lg:px-32 gap-12 relative overflow-hidden py-20 md:py-0">
        ...
        <motion.div 
          ...
          className="relative z-10 w-full h-[300px] md:h-[400px] lg:h-[500px] lg:w-1/2"
        >
          <JewelryCanvas />
        </motion.div>
      </section>
          ...
          {CATEGORIES.map((cat) => (
            <motion.div key={cat.slug} variants={fadeInUp}>
              <Link to={`/shop?category=${cat.slug}`}
                className="group relative bg-slate-50 overflow-hidden rounded-3xl p-8 md:p-12 flex flex-col items-center gap-6 transition-all duration-500 hover:bg-navy hover:-translate-y-2 no-underline block">
      ...
      <section className="container py-20 md:py-32">
        <motion.div 
          {...fadeInUp}
          className="relative rounded-3xl overflow-hidden bg-navy p-10 md:p-20 text-center flex flex-col items-center"
        >
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            >
              <Sparkles size={40} className="text-gold mb-8 mx-auto" />
            </motion.div>
